 ...
 * 更新履歴：2017/09/20 張虎強(SYS)		1.05		(案件C41004)法人仲介担当者登録機能追加対応
...
public interface IUKG01010Dao {
  ...
  //########## 2017/08/04 MJEC)長倉 ADD End
	 ...
	 * @param tantouCds ログイン情報.店舗コード.担当者リス
	 * @return 担当者の当月の受付組数,担当者の保有組数
	 */
	public Map<String, Object> getUketukeKumiSuu(String kaisyaCd,String postCd,String tantouCds)throws Exception;
	// ########## 2013/01/25 林森 ADD End
	 ...
	 * @param kokyaku_name_chk   顧客名(含む)
	 * @param kokyaku_name_k     顧客名カナ
	 * @param kokyaku_name_k_chk 顧客名カナ(含む)
